...
try {
    ...
    $mail->Username   = getenv("GMAIL_USERNAME");                     // SMTP username
    ...
    //Recipients
    $mail->setFrom('hastings.james.m@gmail.com', 'Mailer');
    $mail->addAddress('psalm69er@gmail.com', 'Joe User');     // Add a recipient
